...
test("default model is OpenCode DeepSeek Flash", () => {
  assert.equal(DEFAULT_AI_MODEL, "deepseek-v4-flash-free");
  assert.equal(isValidModelId(DEFAULT_AI_MODEL), true);
  assert.equal(backendForModel(DEFAULT_AI_MODEL), "opencode");
